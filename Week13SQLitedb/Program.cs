...
static void InsertCustomer(SQLiteConnection myConnection)
{
    ...
    Console.WriteLine("Enter dob name (mm-dd-yyyy):");
    dob = Console.ReadLine();

    command = myConnection.CreateCommand();
    command.CommandText = $"INSERT INTO customer(firstName, lastName, dateOdBirth) " +
...
static void RemoveCustomer(SQLiteConnection myConnection)
{
    ...
    command = myConnection.CreateCommand();
    command.CommandText = $"DELETE FROM cusomer WHERE rowid = {idToDelete}";
